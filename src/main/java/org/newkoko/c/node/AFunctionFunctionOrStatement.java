...
public final class AFunctionFunctionOrStatement extends PFunctionOrStatement
{
    private PFunction _function_;

    public AFunctionFunctionOrStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionFunctionOrStatement(
    ...
    {
        ((Analysis) sw).caseAFunctionFunctionOrStatement(this);
    }
