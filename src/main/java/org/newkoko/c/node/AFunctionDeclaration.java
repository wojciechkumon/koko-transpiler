...
public final class AFunctionDeclaration extends PFunctionDeclaration
{
    ...
    private PFunctionType _functionType_;
    ...
    public AFunctionDeclaration(
        ...
        @SuppressWarnings("hiding") PFunctionType _functionType_)
    {
        // Constructor
        setFun(_fun_);
        ...
        setFunctionType(_functionType_);
    ...
    public PFunctionType getFunctionType()
    {
        return this._functionType_;
    }

    public void setFunctionType(PFunctionType node)
    {
        if(this._functionType_ != null)
        {
            this._functionType_.parent(null);
        }
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._functionType_ == child)
        {
            this._functionType_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._functionType_ == oldChild)
        {
            setFunctionType((PFunctionType) newChild);
            return;
        }
