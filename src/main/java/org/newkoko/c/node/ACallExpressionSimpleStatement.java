...
public final class ACallExpressionSimpleStatement extends PSimpleStatement
{
    private PCallExpression _callExpression_;

    public ACallExpressionSimpleStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACallExpressionSimpleStatement(
    ...
    {
        ((Analysis) sw).caseACallExpressionSimpleStatement(this);
    }
