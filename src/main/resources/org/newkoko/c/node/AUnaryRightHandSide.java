...
public final class AUnaryRightHandSide extends PRightHandSide
{
    private PUnaryExpression _unaryExpression_;

    public AUnaryRightHandSide()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnaryRightHandSide(
    ...
    {
        ((Analysis) sw).caseAUnaryRightHandSide(this);
    }
